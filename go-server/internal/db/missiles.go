...
// later on 14 Sep 2026), missiles_5 73, missiles_10 140 and missiles_20 220
// (48, 90 and 170 before the owner re-priced them the same day). The
...
var MissilePacks = map[string]MissilePack{
	...
	"missiles_5":  {ID: "missiles_5", Missiles: 5, Diamonds: 73},
	"missiles_10": {ID: "missiles_10", Missiles: 10, Diamonds: 140},
	"missiles_20": {ID: "missiles_20", Missiles: 20, Diamonds: 220},
}
