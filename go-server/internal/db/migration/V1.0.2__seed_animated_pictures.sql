-- King Teen Patti — three more animated pictures (DML).
--
...
--
--   Butterfly Flapping  1000×1000, 5 s, Lottie 4.8.0   1 DIAMOND   sort_order 170
--   Toucan Flying       1920×1080, 4 s, Lottie 5.5.7   1 DIAMOND   sort_order 180
--   Live Chatbot         952×784,  3 s, Lottie 5.9.6   3 DIAMONDS  sort_order 190
--
...
SELECT name, asset_url, asset_format, currency, type, cost, duration_days, is_active, sort_order,
  ...
  FROM (VALUES
    ...
    ('Live Chatbot',       'https://drive.google.com/uc?export=download&id=1msaoUAeJipCWCy0q8TABPKxWc8ExLMjm',
     'LOTTIE', 'DIAMOND', 'PREMIUM', 3::bigint, 100, TRUE, 190)
