-- King Teen Patti — two more animated pictures (DML).
--
...
-- itself.
--
-- Both are priced like Orange Ballerina — a Lottie animation for one DIAMOND on
-- a 100-day rental — and follow it on the Premium (Animated) shelf:
--
--   Butterfly Flapping  1000×1000, 5 s, Lottie 4.8.0          sort_order 170
--   Toucan Flying       1920×1080, 4 s, Lottie 5.5.7          sort_order 180
--
