#!/usr/bin/env python3
"""Draws sixteen table pictures — eight designs, a day and a night file each —
that the server can serve from public/tables/ but does NOT seed: the seeded
catalogue (V1.0.1__seed.sql, THE TABLE PICTURES) holds the owner's own art, and
a row for one of these is that row's shape with the two /tables/ paths.
