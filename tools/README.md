...
connected ends the run, and the last healthy stage is the ceiling. The generator is a single
Node process; above roughly 5,000 bots it can become the bottleneck itself, which the report's
`gen-lag` column shows.
